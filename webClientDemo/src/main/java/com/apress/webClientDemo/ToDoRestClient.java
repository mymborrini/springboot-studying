package com.apress.webClientDemo;
...
import com.apress.webClientDemo.domain.ToDo;
import com.apress.webClientDemo.error.ToDoErrorHandler;
import com.apress.webClientDemo.properties.ToDoRestClientProperties;
...
public class ToDoRestClient {
  ...
  public ToDoRestClient(ToDoRestClientProperties properties) {
    ...
    System.err.println(properties.getBasePath());
  ...
  public Iterable<ToDo> findAll() throws URISyntaxException {
    ...
    RequestEntity<Iterable<ToDo>> requestEntity = new RequestEntity<Iterable<ToDo>>(HttpMethod.GET,
        new URI(properties.getUri() + properties.getBasePath()));
  ...
  public ToDo findById(String id) {
    ...
    return restTemplate.getForObject(properties.getUri() + properties.getBasePath() + "/{id}", ToDo.class, params);
  }
  ...
  public ToDo setCompleted(String id) {
    Map<String, String> params = new HashMap<>();
    params.put("id", id);
    restTemplate.postForObject(properties.getUri() + properties.getBasePath() + "/{id}?_method=patch", null,
  ...
  public void delete(String id) {
    Map<String, String> params = new HashMap<>();
    params.put("id", id);
    restTemplate.delete(properties.getUri() + properties.getBasePath() + "/{id}", params);
  }
}
