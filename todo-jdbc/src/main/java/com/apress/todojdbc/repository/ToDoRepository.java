package com.apress.todojdbc.repository;
...
import com.apress.todojdbc.domain.ToDo;
...
public class ToDoRepository implements CommonRepository<ToDo> {
  ...
  /**
   * The NamedParameter is a jdbc template which help in declaring the names,
   * so you can substitute ? with a :(name)
   */
